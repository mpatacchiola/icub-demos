...
import threading
import random
from deepgaze_local.color_classification import HistogramColorClassifier
from deepgaze_local.color_detection import BackProjectionColorDetector
from deepgaze_local.mask_analysis import BinaryMaskAnalyser
...
class iCub:
    ...
    def recall_object_from_histogram(self, template):
        ...
        if self.histogram_classifier.returnSize() == 0:
            ...
            return self.histogram_classifier.returnBestMatchName(template, method="intersection")
